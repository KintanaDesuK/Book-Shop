...
namespace Book_Shop.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.Email, Name = Input.Name, Email = Input.Email, EmailConfirmed = true, PhoneNumber = Input.PhoneNumber, Address = Input.Address };
